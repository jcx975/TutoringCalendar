...
?>
		  ...
		  <div class="header-hero text-center">
			<div class="row hero">
			  ...
			  <div class="large-7 large-offset-5 medium-8 columns">	
				...
				<br>
				<a href="<?php print($path) ?>donate/" class="medium button button-yellow special-button">DONATE</a>
	...
	<div id="newsHomepage">
		...
		<!-- | news items |-->
		<div class="row show-for-medium " >
			<?php include $path.'news/newsplugin.php'; ?>
			<div class="row">
				<div class="medium-12 columns news">
					<a href="<?php print($path) ?>news" class="button button-purple radius">Read More News <i class="fa fa-chevron-right"></i></a>
				</div>
			</div>
		</div>
    </div>
    <!-- DIVIDER -->
    <div class="row show-for-medium"><img src="<?php print($path) ?>img/line.svg "></div> 
    <br>
    <br>
    ...
    <div class="row firstSection">
        <div class="columns">
            <div class="image large-4 medium-4 small-12 columns">
                <img src="<?php print($path) ?>img/About.png" alt="">
                <h3>About</h3>
            ...
            <div class="image large-4 medium-4 small-12 columns">
                <img src="<?php print($path) ?>img/prospective-students.png" alt="">
            ...
            <div class="image large-4 medium-4 small-12 columns">
                <img src="<?php print($path) ?>img/faculty.png" alt="">
                <h3>Faculty</h3>
    ...
    <div class="row">
        <div class="image small-12 medium-4 large-6 columns">
            <img src="<?php print($path) ?>img/testing-lab.png">
        </div>
    ...
    <div class="row">
        <div class="image small-12 medium-4 medium-push-8 large-6 large-push-6 columns">
            <img src="<?php print($path) ?>img/practicum.png">
        </div>
        <div class="textbox small-12 medium-8 medium-pull-4 large-6 large-pull-6 columns">
            <h2>Practicum</h2>
