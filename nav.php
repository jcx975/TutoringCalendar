	...
	<div class="off-canvas position-right" id="offCanvasRight" data-off-canvas data-position="right">
	  <ul class="vertical dropdown menu" data-dropdown-menu>
	   <br>
		...
		<li class="hover"><label><a href=<?php print($path . '../index.php') ?>>HOME</a></label></li>
	...
	-->
		<li class="hover"><label><a href=<?php print($path . "faculty/") ?>>FACULTY/STAFF</a></label></li>
	  ...
	  <div class="sticky" data-sticky data-margin-top="0" data-sticky-on="large"> 
		...
		<div class="title-bar" data-responsive-toggle="widemenu" data-hide-for="large">
		  <div class="title-bar-left">
			<div class="title-bar-title menu-text-bottom"><a href="http://www.winona.edu" target="_blank"><img  alt="Winona State University Website" class="wsu-flame"  src=<?php print($path . "img/WSU_Flame.png")?>></a><a alt="Home" href=<?php print($path . '../index.php') ?> >COMPUTER SCIENCE</a></div>
		...
		<div id="widemenu" class="top-bar">
		  <div class="top-bar-left">
			<ul class="menu" data-dropdown-menu>        
			  <li class="menu-text-bottom"><div><a href="http://www.winona.edu" target="_blank"><img   title="Winona State University Website" class="wsu-flame" src=<?php  print($path. "img/WSU_Flame.png") ?>></a><a title="Home" href= <?php print($path . '../index.php') ?> >COMPUTER SCIENCE</a></div></li>
			</ul>
		  </div>
		  <div class="top-bar-right medium-only-text-center">
			<ul class="menu dropdown" data-dropdown-menu data-closing-time="100">
			  <!-- home page of site is one level up from cs-website -->
			  <li><a href= <?php print($path . '../index.php') ?> >HOME</a></li>
			...
			-->
			  ...
			  <li><a href=<?php print($path . "faculty/") ?> ?>FACULTY/STAFF</a></li>
