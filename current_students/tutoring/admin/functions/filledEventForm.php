	...
	if(!function_exists("filledEventForm"))
	{
		function filledEventForm($dayOfTheWeek,$start,$startIncrement,$startMod,$end,$endIncrement,$endMod,$location,$class)
		{
			...
			$filledForm =
				...
				. "<div class='medium-12 columns'><span class='tut-deleteevent-button red'>&times;</span></div>"
				...
				. "<div class='medium-2 columns'>AM/PM<select form='save' name='endMod[]'>" . $selectEndAmPm . "</div>"
				. "<div class='medium-3 columns'>Location<input type='text' form='save' name='location[]' value='" . $location . "' required></div>"
				. "<div class='medium-3 columns'>Class<input type='number' form='save' name='class[]' min='101' max='999' placeholder='e.g. \"234\"' value='" . $class . "' required></div>"
				. "<div class='medium-6 columns'></div></div>";
