...
<footer class="footer">
  <div class="row full-width">
    <div class="small-12 medium-4 large-4 columns">
		<a target="_blank" href="http://www.winona.edu"><img src= <?php print($path . "img/footer_logo.png")  ?> alt="Winona State Universtiy" ></a>
		<p>
			<br>
    ...
    <div class="small-12 medium-4 large-5 columns footer-center-col">
		...
		<p>
			...
			Winona and Rochester campuses; provide a welcoming and supportive learning environment 
    ...
    <div class="small-12 medium-4 large-3 columns align-left">
		...
		<ul class="footer-links">
			<li> <a href="mailto:mlange@winona.edu"><i class="fi-mail"></i> E-mail</a></li>
  ...
  <div class="row">
		<p class="developers">
			...
			website: <a href='<?=($path . "developers/developers.php") ?>'>CLICK HERE</a>
		</p>   
  </div>
</footer>
...
<script src="<?=$path?>js/vendor/foundation.min.js"></script>
<script src="<?=$path?>js/vendor/what-input.js"></script>
<script src="<?=$path?>js/app.js"></script>
<script src="<?=$path?>js/newslinks.js"></script>
<script src="<?=$path?>js/totop.js"></script>	